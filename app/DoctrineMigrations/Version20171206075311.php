 ...
 */
class Version20171206075311 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE chi_tiet_hd (id INT AUTO_INCREMENT NOT NULL, id_hd INT DEFAULT NULL, id_sp INT DEFAULT NULL, SL INT NOT NULL, TenSP VARCHAR(255) NOT NULL, DonGia INT NOT NULL, ThanhTien INT NOT NULL, INDEX IDX_1E0F9BFB665FAF16 (id_hd), UNIQUE INDEX UNIQ_1E0F9BFBD5B3B0F1 (id_sp), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE hoa_don (id INT AUTO_INCREMENT NOT NULL, id_kh INT DEFAULT NULL, NgayDat DATETIME NOT NULL, NgayGiao DATETIME NOT NULL, TrangThai VARCHAR(255) NOT NULL, TongTien INT NOT NULL, UNIQUE INDEX UNIQ_EC1A79B144C4B0FE (id_kh), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE san_pham (id INT AUTO_INCREMENT NOT NULL, TenSP VARCHAR(255) NOT NULL, MoTaCT LONGTEXT NOT NULL, Gia INT NOT NULL, id_LoaiSP INT DEFAULT NULL, INDEX IDX_809F457CCA6C016F (id_LoaiSP), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
